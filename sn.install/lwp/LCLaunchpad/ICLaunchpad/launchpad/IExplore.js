...
// This is mostly for FF extension code, but we want to return something 
// useful if not in FF.
// Return the starting dir - useful for finding non-launchpad files
function getExternalTopDir() {
	return top.getStartingTopDir();
}
