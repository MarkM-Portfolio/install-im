...
#put value from TAD config to PREREQ_CHECKER config for the current PRODUCT and SYSTEM
copyValue() {
	VAL_TO=$1 ; VAL_FROM=$2
	VALUE=`getValue ${PRODUCT}_${SYSTEMID}_${VAL_FROM} ${TAD_CFG}`
...
DEBUG_FILE="TAD_debug.log"

if [ -f ${DEBUG_FILE} ]; then
	rm -f ${DEBUG_FILE}
fi

TAD_CFG="TADplugin.cfg"
isWasAgent=
