...
Set allOS = objWMI.ExecQuery("Select TotalVisibleMemorySize from Win32_OperatingSystem",,48)

For Each os in allOS
	WScript.Echo "os.totalPhysicalMemory=" & int(os.TotalVisibleMemorySize/1024) & "MB"
Next
