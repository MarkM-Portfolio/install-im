...
strServiceName = "RemoteRegistry" ' Windows Remote Registry service
' Deprecating os.remoteRegistryEnabled and moving to os.isServiceRunning.*
WScript.Echo "os.remoteRegistryEnabled=" & isServiceRunning(strServiceName)
WScript.Echo "os.isServiceRunning.remoteRegistry=" & isServiceRunning(strServiceName)
