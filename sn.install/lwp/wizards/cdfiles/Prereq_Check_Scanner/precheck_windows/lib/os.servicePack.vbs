...
Set allOS = objWMI.ExecQuery("Select ServicePackMajorVersion, ServicePackMinorVersion from Win32_OperatingSystem",,48)

For Each os in allOS
	WScript.Echo "os.servicePack=" & os.ServicePackMajorVersion & "." & os.ServicePackMinorVersion
Next
