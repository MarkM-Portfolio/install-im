...
Set allOS = objWMI.ExecQuery("Select TotalVirtualMemorySize from Win32_OperatingSystem",,48)

For Each os in allOS
	WScript.Echo "os.totalMemory=" & int(os.TotalVirtualMemorySize/1024) & "MB"
Next
