...
'
' File:     Windows/os.servicePack_compare.vbs
' Version:  1.1.1.7
' Modified: 08/25/11
' Build:    20110825
'
...
wscript.echo osServicePackCompare(wscript.arguments(0), wscript.arguments(1))
...
function osServicePackCompare(expect, real)
	if len(real) = 0 then
		osServicePackCompare = "FAIL"
		exit function
	end if
