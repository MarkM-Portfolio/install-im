...
//	private Label cboServerLabel = null;
	...
	private boolean hostNameFlag = false, portFlag = false,
				...
				if (cboServer.getSelectionIndex() == 1) {
					if (sameDBButton.getSelection() == true) {
						...
						if (ic360PasswordText1 != null) {
							ic360DBNameText1.setText(DBInfo
									.getProperty("ic360.dbName.db2"));
							wikisUseridText1.setText(DBInfo
									.getProperty("wikis.dbUserName.db2"));
						}
					...
					if (diffDBButton.getSelection() == true) {
						...
						if (ic360PasswordText2 != null) {
							...
							ic360DBNameText2.setText(DBInfo
									.getProperty("ic360.dbName.db2"));
							ic360UseridText2.setText(DBInfo
					...
					if (sameDBButton.getSelection() == true) {
						...
						if (ic360PasswordText1 != null) {
							ic360DBNameText1.setText(DBInfo
									.getProperty("ic360.dbName.oracle"));
							ic360UseridText1.setText(DBInfo
									.getProperty("ic360.dbUserName.oracle"));
						}
						if (ccmGCDPasswordText1 != null){
							if (profile.getUserData("user.ccm.existingDeployment").equals("false")) {
								ccmFeatureNameLabel1.setVisible(true);
					...
					if (sameDBButton.getSelection() == true) {
						...
						if (ic360PasswordText1 != null) {
							ic360DBNameText1.setText(DBInfo
									.getProperty("ic360.dbName.sqlserver"));
							ic360UseridText1.setText(DBInfo
									.getProperty("ic360.dbUserName.sqlserver"));
						}
						if (ccmGCDPasswordText1 != null){
							if (profile.getUserData("user.ccm.existingDeployment").equals("false")) {
								ccmFeatureNameLabel1.setVisible(true);
...
//		this.portText.setText("50000");
				...
				public void modifyText(ModifyEvent e) {
					...
					if (obj instanceof Text) {
						...
						if (checkbox1.getSelection()) {
							...
							if (ic360PasswordText1 != null) {
								ic360PasswordText1.setText(text.getText());
							}
						}
					}
				}
						...
						public void modifyText(ModifyEvent e) {
							...
							if (obj instanceof Text) {
								...
								if (checkbox2.getSelection()) {
									...
									if (ic360PasswordText2 != null) {
										ic360PasswordText2.setText(text
												.getText());
									}
								}
							}
	...
	private void setData() {
		...
		if (isFeatureSelected(Constants.FEATURE_ID_ACTIVITIES)) {
			setDBUserData(Constants.FEATURE_ID_ACTIVITIES, dbType, jdbcLibPath, activitiesHostName, activitiesPort, ACTIVITIES_DB_NAME, activitiesUsername, EncryptionUtils.encrypt(activitiesPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_BLOGS)) {
			setDBUserData(Constants.FEATURE_ID_BLOGS, dbType, jdbcLibPath, blogsHostName, blogsPort, BLOGS_DB_NAME, blogsUsername, EncryptionUtils.encrypt(blogsPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_COMMUNITIES)) {
			setDBUserData(Constants.FEATURE_ID_COMMUNITIES, dbType, jdbcLibPath, communitiesHostName, communitiesPort, COMMUNITIES_DB_NAME, communitiesUsername, EncryptionUtils.encrypt(communitiesPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_BOOKMARKS)) {
			setDBUserData(Constants.FEATURE_ID_BOOKMARKS, dbType, jdbcLibPath, dogearHostName, dogearPort, DOGEAR_DB_NAME, dogearUsername, EncryptionUtils.encrypt(dogearPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_PROFILES)) {
			setDBUserData(Constants.FEATURE_ID_PROFILES, dbType, jdbcLibPath, profilesHostName, profilesPort, PEOPLEDB_DB_NAME, profilesUsername, EncryptionUtils.encrypt(profilesPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_WIKIS)) {
			setDBUserData(Constants.FEATURE_ID_WIKIS, dbType, jdbcLibPath, wikisHostName, wikisPort, WIKIS_DB_NAME, wikisUsername, EncryptionUtils.encrypt(wikisPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_FILES)) {
			setDBUserData(Constants.FEATURE_ID_FILES, dbType, jdbcLibPath, filesHostName, filesPort, FILES_DB_NAME, filesUsername, EncryptionUtils.encrypt(filesPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_FORUMS)) {
			setDBUserData(Constants.FEATURE_ID_FORUMS, dbType, jdbcLibPath, forumHostName, forumPort, FORUM_DB_NAME, forumUsername, EncryptionUtils.encrypt(forumPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_NEWS) || isFeatureSelected(Constants.FEATURE_ID_SEARCH) || isFeatureSelected(Constants.FEATURE_ID_HOMEPAGE)) {
			setDBUserData(Constants.FEATURE_ID_NEWS, dbType, jdbcLibPath, homepageHostName, homepagePort, HOMEPAGE_DB_NAME, homepageUsername, EncryptionUtils.encrypt(homepagePassword));
			setDBUserData(Constants.FEATURE_ID_SEARCH, dbType, jdbcLibPath, homepageHostName, homepagePort, HOMEPAGE_DB_NAME, homepageUsername, EncryptionUtils.encrypt(homepagePassword));
			setDBUserData(Constants.FEATURE_ID_HOMEPAGE, dbType, jdbcLibPath, homepageHostName, homepagePort, HOMEPAGE_DB_NAME, homepageUsername, EncryptionUtils.encrypt(homepagePassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_METRICS)) {
			setDBUserData(Constants.FEATURE_ID_METRICS, dbType, jdbcLibPath, metricsHostName, metricsPort, METRICS_DB_NAME, metricsUsername, EncryptionUtils.encrypt(metricsPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_MOBILE)) {
			setDBUserData(Constants.FEATURE_ID_MOBILE, dbType, jdbcLibPath, mobileHostName, mobilePort, MOBILE_DB_NAME, mobileUsername, EncryptionUtils.encrypt(mobilePassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_PUSHNOTIFICATION)) {
			setDBUserData(Constants.FEATURE_ID_PUSHNOTIFICATION, dbType, jdbcLibPath, pushnotificationHostName, pushnotificationPort, PUSHNOTIFICATION_DB_NAME, pushnotificationUsername, EncryptionUtils.encrypt(pushnotificationPassword));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_IC360)) {
			setDBUserData(Constants.FEATURE_ID_IC360, dbType, jdbcLibPath, ic360HostName, ic360Port, IC360_DB_NAME, ic360Username, EncryptionUtils.encrypt(ic360Password));
		}
		if (isFeatureSelected(Constants.FEATURE_ID_CCM) && this.profile.getUserData("user.ccm.existingDeployment").equals("false")){
			...
			profile.setUserData("user.ccm.gcd.dbUserPassword", EncryptionUtils.encrypt(ccmGCDPassword));
			...
			profile.setUserData("user.ccm.objstore.dbUserPassword", EncryptionUtils.encrypt(ccmOSPassword));
		}
	}
	...
	class DBProgressMonitor implements IRunnableWithProgress {
		...
		private void checkDB(String dbName, String dbUserName, String dbUserPwd, String dbHostName, String dbPort, String msg, String appName) {
			int result = -1;
			dv.dbConnection(getProfile(), dbtype, dbHostName, dbPort, dbName, dbUserName, dbUserPwd, getPropertiesFile(), jdbcDriver, appName);
		...
		public void run(IProgressMonitor monitor) {
			monitor.beginTask(Messages.DB_START_VALID, 13);
	...
	private void dbConnection() {
		try {
			...
			DBProgressMonitor dialog = new DBProgressMonitor(hostnameText.getText(), portText.getText(),
	...
	private void setTheSamePassword_1(Button check) {
		if (check.getSelection()) {
			...
			if (isFeatureSelected("ic360")) {
				...
				if (activitiesPasswordText1 != null) {
					activitiesPasswordText1.setText(ic360PasswordText1
							.getText());
				}
				if (blogsPasswordText1 != null) {
					blogsPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (dogearPasswordText1 != null) {
					dogearPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (communitiesPasswordText1 != null) {
					communitiesPasswordText1.setText(ic360PasswordText1
							.getText());
				}
				if (filesPasswordText1 != null) {
					filesPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (forumPasswordText1 != null) {
					forumPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (homepagePasswordText1 != null) {
					homepagePasswordText1.setText(ic360PasswordText1.getText());
				}
				if (metricsPasswordText1 != null) {
					metricsPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (mobilePasswordText1 != null) {
					mobilePasswordText1.setText(ic360PasswordText1.getText());
				}
				if (profilesPasswordText1 != null) {
					profilesPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (pushnotificationPasswordText1 != null) {
					pushnotificationPasswordText1.setText(ic360PasswordText1
							.getText());
				}
				if (ccmGCDPasswordText1 != null && ccmGCDPasswordText1.isVisible()){
					ccmGCDPasswordText1.setText(ic360PasswordText1.getText());
				}
				if (ccmOSPasswordText1 != null && ccmOSPasswordText1.isVisible()){
					ccmOSPasswordText1.setText(ic360PasswordText1.getText());;
				}
	...
	private void setTheSamePassword_2(Button check) {
		if (check.getSelection()) {
			...
			if (isFeatureSelected("activities")) {
				...
				if (pushnotificationPasswordText2 != null) {
					pushnotificationPasswordText2.setText(pushnotificationPasswordText2
							.getText());
				}
				if (ic360PasswordText2 != null) {
			...
			if (isFeatureSelected("ic360")) {
				...
				if (activitiesPasswordText2 != null) {
					activitiesPasswordText2.setText(ic360PasswordText2
							.getText());
				}
				if (blogsPasswordText2 != null) {
					blogsPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (dogearPasswordText2 != null) {
					dogearPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (communitiesPasswordText2 != null) {
					communitiesPasswordText2.setText(ic360PasswordText2
							.getText());
				}
				if (filesPasswordText2 != null) {
					filesPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (forumPasswordText2 != null) {
					forumPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (homepagePasswordText2 != null) {
					homepagePasswordText2.setText(ic360PasswordText2.getText());
				}
				if (metricsPasswordText2 != null) {
					metricsPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (mobilePasswordText2 != null) {
					mobilePasswordText2.setText(ic360PasswordText2.getText());
				}
				if (profilesPasswordText2 != null) {
					profilesPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (pushnotificationPasswordText2 != null) {
					pushnotificationPasswordText2.setText(pushnotificationPasswordText2
							.getText());
				...
				if (ccmGCDPasswordText2 != null && ccmGCDPasswordText2.isVisible()){
					ccmGCDPasswordText2.setText(ic360PasswordText2.getText());
				}
				if (ccmOSPasswordText2 != null && ccmOSPasswordText2.isVisible()){
					ccmOSPasswordText2.setText(ic360PasswordText2.getText());
				}
				return;
			}
