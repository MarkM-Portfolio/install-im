...
public class WPMPUpdateHarnessManager extends WPUpdateHarnessManager {

	public WPMPUpdateHarnessManager(String productDir){		
      super( productDir );
	}

   protected UpdateStrategy getUpdateStrategy( String productDir ) {
      return new WPMPUpdateStrategy( productDir );
   }
}
