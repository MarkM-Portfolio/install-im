...
public abstract class ExtendedWpcpRuntimeEarAction extends ExtendedWPEarAction {
   ...
   public final static String pgmUpdate = "9/26/03" ;
    ...
    public ExtendedWpcpRuntimeEarAction() {
        super();
    }
    ...
    public ExtendedEARActor createActor(String installPath,
       ...
       return new WpcpRuntimeEarActor( getWasHomeDir(),
                    				 messages, errors,
                    				 earName,
