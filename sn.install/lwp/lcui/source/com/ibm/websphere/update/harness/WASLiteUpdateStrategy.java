...
/**
 * Class: WASLiteStrategy.java Abstract: Enables IHS to be updated within the current PTF strategy as a WAS-LITE product Component Name: WAS.ptf Release: ASV50X History 1.3, 3/13/03 01-Feb-2003 Initial Version
 */

public class WASLiteUpdateStrategy extends WASAbstractUpdateStrategy {
...
//	private List consumedExceptions;
	...
	public WASLiteUpdateStrategy(String productDir) {
		super(productDir);
