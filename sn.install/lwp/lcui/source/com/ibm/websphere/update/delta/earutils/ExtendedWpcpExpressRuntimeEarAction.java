...
public abstract class ExtendedWpcpExpressRuntimeEarAction extends ExtendedWPEarAction {
   ...
   public final static String pgmUpdate = "9/26/03" ;
    ...
    public ExtendedWpcpExpressRuntimeEarAction() {
        super();
    }
    ...
    public ExtendedEARActor createActor(String installPath,
       ...
       return new WpcpExpressRuntimeEarActor( getWasHomeDir(),
                    				 messages, errors,
                    				 earName,
