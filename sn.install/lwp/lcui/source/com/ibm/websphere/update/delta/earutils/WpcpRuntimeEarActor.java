...
public class WpcpRuntimeEarActor extends WPEarActor {
   public final static String pgmVersion = "1.2" ;
   public final static String pgmUpdate = "9/26/03" ;

   public WpcpRuntimeEarActor(String installPath, StringBuffer messages, StringBuffer errors,
                         String earName,
   ...
   protected String getEarName() { return "WPCP_Runtime.ear"; }
   protected String getEarAppName() { return "WPCP_Runtime"; }
