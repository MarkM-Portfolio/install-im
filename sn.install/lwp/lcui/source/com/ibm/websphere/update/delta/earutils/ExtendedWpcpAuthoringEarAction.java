...
public abstract class ExtendedWpcpAuthoringEarAction extends ExtendedWPEarAction {
   ...
   public final static String pgmUpdate = "9/26/03" ;
    ...
    public ExtendedWpcpAuthoringEarAction() {
        super();
    }
    ...
    public ExtendedEARActor createActor(String installPath,
       ...
       return new WpcpAuthoringEarActor( getWasHomeDir(),
                    				 messages, errors,
                    				 earName,
