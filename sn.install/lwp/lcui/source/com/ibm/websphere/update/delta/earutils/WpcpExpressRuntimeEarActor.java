...
/*
 *  @ (#) WpcpRuntimeEarActor.java
 *
 *  Perform WPCP_Runtime EAR pre and post processing operations.
 *
...
public class WpcpExpressRuntimeEarActor extends WPEarActor {
   public final static String pgmVersion = "1.2" ;
   public final static String pgmUpdate = "9/26/03" ;

   public WpcpExpressRuntimeEarActor(String installPath, StringBuffer messages, StringBuffer errors,
                         String earName,
   ...
   protected String getEarName() { return "WPCP_Express_Runtime.ear"; }
   protected String getEarAppName() { return "WPCP_Express_Runtime"; }
   protected String getEarInstalledLocation() { return WPConfig.getProperty( WPConstants.PROP_WP_HOME ) + File.separator + "wpcp" + File.separator + "v5.0" + File.separator + "runtime"+ File.separator + "installableApps"; }
