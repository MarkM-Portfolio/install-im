    ...
    extends efixBaseImageInstaller
{
    ...
    public static final String pgmUpdate = "11/3/02" ;
                           ...
                           Notifier notifier, IOService ioService)
    {
    	...
    	//System.out.println("efix.efixUninstaller.java");        
        setEFixId(null);
    }

    // Active efix handling ...
    //
    //    void setEFixId(String);
    //    String getEFixId();
    ...
    protected void setEFixId(String efixId)
    {
        this.efixId = efixId;
    ...
    protected boolean readEFixDriver()
    {
        ...
        activeEFixDriver = getEFixDriverById();
    ...
    protected updateEvent baseUninstall()
    {
        ...
        if ( readEFix() && readEFixDriver() && prepareComponents() && saveEvents(CREATE_BACKUP) ) {
    ...
    protected boolean uninstallComponents(updateEvent parentEvent)
    {
        ...
        for ( int componentNo = 0;
            ...
            componentApplied nextApplied =
                getWPHistory().getEFixComponentAppliedById(getEFixId(), nextComponentName);
                                            ...
                                            componentApplied childApplied)
    {
        ...
        try {
            ...
            logFlush("Using backup file " + childApplied.getBackupName());

            String args[] = {
                "-JarInputFile", childApplied.getBackupName(),
                "-LogFile",      childEvent.getLogName(),
                "-TargetDir",    getWPHistory().getProductDirName(),
