...
public class IOServicesException
    extends UpdateException
{
    ...
    protected static final String bundleId = "com.ibm.websphere.update.ioservices.IOServicesNLS";
    ...
    public IOServicesException(String msgKey)
    {
        this(msgKey, null, null);
    }

    public IOServicesException(String msgKey, Exception exception)
    {
        this(msgKey, null, exception);
    }

    public IOServicesException(String msgKey, Object[] msgArgs, Exception exception)
    {
