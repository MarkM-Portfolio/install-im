 ...
 *  @ (#) WmmEarEARActor.java
 *
 *  Perform WmmEar EAR pre and post processing operations.
 *
...
public class WmmEarEARActor extends WPEarActor {
   public final static String pgmVersion = "1.2" ;
   public final static String pgmUpdate = "9/26/03" ;

   public WmmEarEARActor(String installPath, StringBuffer messages, StringBuffer errors,
                         String earName,
