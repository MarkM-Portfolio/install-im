...
/**
 * <p>Class WASProductException encodes an exception throw by WASProduct. An exception may or may not be bound within a WASProductException instance.  A NLS enabled message may be set within a WASProductException.</p>
 */

public class WASProductException extends Exception
{
    // Program versioning ...
    ...
    public WASProductException(String msgKey)
    {
        this(msgKey, null);
    }

    // Another on an NLS enabled message plus an exception ...
    ...
    public WASProductException(String msgKey, Exception exception)
    {
    ...
    public WASProductException(String msgKey, Object[] msgArgs, Exception exception)
    {
        text = WASProduct.getString(msgKey);
