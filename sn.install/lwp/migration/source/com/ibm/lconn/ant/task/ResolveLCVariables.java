 ...
 *
 */
public class ResolveLCVariables extends BaseTask {
	...
	public void execute() throws BuildException {
		...
		while (iter.hasNext()) {
			ResolveLCVariables.Element entry = (ResolveLCVariables.Element) iter
					.next();
	...
	private String readProperty(String feature, String variable) {
		...
		String featureProfile = p.getProperty(feature+".ProfileName");
