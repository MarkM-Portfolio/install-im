...
"""
def addLDAPRepository(ldapType, ldapHost, ldapPort, ldapUser, ldapPassword, ldapSSL, loginAttributes):
...
def main(argv):
	...
	if(ldapType!="" and ldapHost!="" and ldapPort!="" and ldapUser!="" and ldapPassword!=""):
		if(ldapSSL==""):
			ldapSSL="false"
		
		ret = addLDAPRepository(ldapType, ldapHost, ldapPort, ldapUser, ldapPassword, ldapSSL, loginAttributes)
		if(ret !=0):
			isSuccess=ret
		isActionDone = 3
